        ...
        <div class="inner_wrap">
            ...
            <div class="right">
                ...
                <div class="section p_info" id="p_info_0">
                	<h5>안정된 프로파일</h5>
                    <p class="desc">트리니타스 T2는 안정된 열량을 공급하고 유지하도록 설계되어 투입온도, 투입열량, 배출온도 이 세가지만 결정되면 사용자가 구축한 프로파일을 일정하게 재현합니다.</p>
                ...
                <div class="section p_info" id="p_info_2">
                    ...
                    <img class="lazy" data-original="inc/img/products_trinitas2_img_2.png" alt="Novustec Trinitas T2" /> 
                </div><!--.section-->  
                
                <div class="section p_info" id="p_info_3">
                	<h5>높은 생산량</h5>
                    <p class="desc">풍부한 열량과 강력한 냉각으로 시간당 최대 10Kg의 원두를 생산할 수 있습니다. 트리니타스 T2는 2개의 구동모터를 이용하여 드럼과 냉각교반을 작동하고 2개의 송풍모터를 이용하여 배기와 냉각을 합니다. 총 4개의 독립모터가 빠른 연속배치를 가능하게 합니다.</p>
                ...
                <div class="section p_info" id="p_info_4">
                	<h5>편리한 유지보수</h5>
                    <p class="desc">트리니타스 T2는 심플하고 직관적인 구조로 체프의 배출과 배기관에 발생하는 슬러지의 청소가 매우 용이합니다.</p>
                    <img class="lazy" data-original="inc/img/products_trinitas2_img_4.png" alt="Novustec Trinitas T2" /> 
                </div><!--.section-->       
                                       
                
            	<div class="section" id="spec">
                	<h4>Specifications: TRINITAS T2</h4>
 <div align="center"><img src="inc/img/spec01.jpg" width="500" height="548" alt="T2_Spec"/></div>
                                                                                                       
                </div><!--.section-->                                                              
              <div class="section" id="spec">
               	<h4>Plug & Play : TRINITAS T2 with Cropster</h4>
