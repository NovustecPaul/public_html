...
<div id="main" class="wrap">
    ...
    <div id="bd">
        	...
        	<div id="img_slide_text_box">
            	<h2>
                	<div id="roll_title_wrap">
                        ...
                        <p class="roll_2">Service Exellence</p>
                    </div>
                </h2>
				<div class="desc">
        ...
        <div id="main_con">
            ...
            <p class="desc">노부스테크는 로스터기를 제작 판매하는 것을 넘어, 최고의 커피 로스팅 노하우를 노부스테크 만의 차별화된 서비스로  제공해드립니다.</p>
            
            <div id="main_support_con_wrap">
            	<dl id="main_support_con_0">
                	<dt>Phone Care Service</dt>
                    <dd class="desc">고객들의 문제에만 반응하는 서비스가 아닙니다. Novustec의 전문 로스터가 먼저 정기적으로 전화를 드리고, 로스터기의 점검과 함께로스팅  프로파일이나 기타 궁금한 부분을 안내해드립니다.</dd>
                    <dd class="icon"></dd>
                </dl>

            	<dl id="main_support_con_1">
                	<dt>Shop Care Service</dt>
                    <dd class="desc">문제가 생기는 것 보다 먼저 예방하는 것이 좋지 않을까요? 정기적으로 고객을 방문하여 로스터기 사전 점검 및 기기 청소등의 케어 서비스를 제공합니다.</dd>
                    <dd class="icon"></dd>
                </dl>
                
            	<dl id="main_support_con_2">
                	<dt>Warranty Service</dt>
                    <dd class="desc">1년간 무상 A/S가 제공되며, Extended Warranty를 통해 보증기간을 연장할 수 있습니다.</dd>
                    <dd class="icon"></dd>
                </dl>          
                <div class="cb"></div>                  
