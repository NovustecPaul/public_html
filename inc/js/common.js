...
<div id="contact_us">\
	...
	<p>궁금한 내용이나 질문을 주시면 빠른 시간 내에 답변 드리도록 하겠습니다.</p>\
    <div class="btn_close"></div>\
    <form>\
		<input id="guest_name" type="text" class="input_text" value="이름" />\
		<input id="guest_email" type="text" class="input_text" value="이메일" />\
		<textarea id="guest_msg">메세지</textarea>\
		<input id="btn_submit" type="submit" value="보내기" />\
    </form>\
    <dl>\
    	<dt>NOVUSTEC</dt>\
        <dd class="addr">경기도 성남시 중원구 갈마치로 215,<br/> 금강펜테리움IT타워 A동 503호<br /><span>월 - 금, AM 8:00 – PM 6:00</span></dd>\
